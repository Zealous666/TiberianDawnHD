...
actor-aot-ore-depot =
    .name = Ore Depot (Rich)
    .generic-name = Ore Depot (Rich)

actor-aot-ore-depot-prewar =
    .name = Ore Depot (Pre-War)
    .generic-name = Ore Depot (Pre-War)
...
# aotmod: In-game hover (Tooltip.Name) fuer alle transformierbaren Baeume.
meta-tiberium-infested-tree-name = Tiberium Infested Tree
