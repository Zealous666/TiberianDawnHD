...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class Bridge : INotifyDamageStateChanged
	{
		...
		// Cells this bridge (span) covers. Used by AI terrain analysis to treat a crossing as a
		// potential land route even when the bridge is currently destroyed (the enemy could rebuild it).
		public IEnumerable<CPos> FootprintCells => footprint?.Keys ?? (IEnumerable<CPos>)Array.Empty<CPos>();
