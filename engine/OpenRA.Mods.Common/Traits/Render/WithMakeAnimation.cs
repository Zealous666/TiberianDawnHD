...
namespace OpenRA.Mods.Common.Traits.Render
{
	...
	public class WithMakeAnimation : INotifyCreated, INotifyAddedToWorld, INotifyDeployTriggered
	{
		...
		public bool HasActiveBody() => wsbs.FirstEnabledConditionalTraitOrDefault() != null;
