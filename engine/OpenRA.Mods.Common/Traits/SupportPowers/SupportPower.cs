...
namespace OpenRA.Mods.Common.Traits
{
	public abstract class SupportPowerInfo : PausableConditionalTraitInfo
	{
		...
		// aotmod: eigene Tooltip-Felder fuer Preis und Voraussetzungen (User 2026-08-04).
		// Vorher stand beides als Fliesstext in der Description -- Tooltips brechen aber keine
		// Zeilen um, das waere eine einzige lange Zeile geworden.
		[Desc("Credit cost to activate, shown in the tooltip. 0 = free (tooltip hides the field).",
			"Only powers that actually charge for activation act on this -- see AutoActivateSpawnActorPower.")]
		public readonly int Cost = 0;

		[Desc("Plain-text requirements shown in the tooltip, e.g. \"Science Lab (GDI) or Temple of Nod (Nod)\".",
			"Purely cosmetic: Age of Tiberium gates its powers via PauseOnCondition rather than the",
