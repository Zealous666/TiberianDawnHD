...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class EditorActorLayer : IWorldLoaded, ITickRender, IRender, IRadarSignature, ICreatePlayers, IRenderAnnotations, INotifyActorDisposing
	{
		...
		// aotmod: read-only Zugriff fuer Editor-Overlays (z.B. AotExpansionMarkerEditorOverlay),
		// die alle platzierten Previews eines Typs einrahmen wollen.
		public IReadOnlyList<EditorActorPreview> Previews => previews;
