...
## === Age of Tiberium (aotmod) — Age-Aufstieg ===
## Klick auf ein fertig geladenes Age-Upgrade ohne ausreichende Deckung. Tiberian Dawn hat keine
## EVA-Ansage dafuer, daher ist dies die einzige Rueckmeldung (User 2026-08-05).
notification-insufficient-funds = Not enough money
