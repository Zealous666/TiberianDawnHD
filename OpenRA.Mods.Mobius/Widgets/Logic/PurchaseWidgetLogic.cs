...
{
	// Ported from OpenRA.Mods.D2k so the AoT (Mobius) mod, which does not load the D2k assembly,
	// can drive the BulkProductionQueue (Dune 2000 / Tiberian Sun "Starport" style delivery) on the NOD Airstrip.
